...
\title{Modbus Based Smart Energy Tracking and Control System}
...
\ResumeFour{Resume 4} % Add Resume of the 4th author if needed
\ResumeFive{Resume 5} % Add Resume of the 5th author if needed
...
\input{chapters/ChapterHowTO} % Since this section is given for help in your thesis, don't forget to disable this section via \% sign before finalizing your report 
